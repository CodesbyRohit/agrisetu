// Inline SVG icon set — consistent stroke icons (lucide-style, 24x24).
// Hand-rolled so there is no runtime font/CDN dependency and every Android
// device renders the same glyphs. All icons inherit currentColor.
...
export function DropletIcon(p: P) {
  return (
    <Svg {...p}>
